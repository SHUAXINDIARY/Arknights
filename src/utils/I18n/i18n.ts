...
export const resources = {
    en: {
        translation: {
            ...
            inspirationAuthor: "随便吧丶不如跳舞",
            careerImage: "'s Career Chart",
            ...
            selectFirstSkin: "Select Your First Purchased Skin",
            ...
            progress_start: "Let's get started, Doctor!",
            progress_quarter: "Nice progress! Keep going~",
            progress_half: "Halfway there! You're doing great!",
            progress_almost: "Almost done! Just a few more!",
            progress_complete: "All done! Ready to generate!",
        },
    },
    jp: {
        translation: {
            ...
            selectFirstSkin: "自分の最初に購入したスキンを選択",
            ...
            "saving...": "保存中...",
            save_success: "保存完了！",
            progress_start: "始めましょう、ドクター！",
            progress_quarter: "いい感じです！続けて～",
            progress_half: "半分まで来ました！頑張って！",
            progress_almost: "もう少しです！ラストスパート！",
            progress_complete: "全部完了！生成しましょう！",
        },
    },
    zh: {
        translation: {
            ...
            "saving...": "保存中...",
            save_success: "保存成功！",
            progress_start: "博士，开始填写吧！",
            progress_quarter: "不错的进度，继续加油~",
            progress_half: "已经过半啦！你很棒！",
            progress_almost: "就差一点点了！冲鸭！",
            progress_complete: "全部完成！可以生成啦！",
        },
    },
} as const;
...
i18n.use(initReactI18next) // passes i18n down to react-i18next
    .init({
        resources,
        lng: langMap[language as keyof typeof langMap] || "en", // language to use, more information here: https://www.i18next.com/overview/configuration-options#languages-namespaces-resources
